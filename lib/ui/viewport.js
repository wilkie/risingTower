 ...
 */
var initUIViewport = function(UI) {
  var Viewport = UI.Viewport = function(phaser, x, y, width, height, world) {
  ...
  Viewport.prototype.getBounds = UI.Screen.prototype.getBounds;
  ...
  Viewport.prototype.reposition = function(screenX, screenY) {
    ...
    this._boundingBox.x = screenX;
    this._boundingBox.y = screenY;
  };
